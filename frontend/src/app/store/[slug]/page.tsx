    ...
    <main className="min-h-screen bg-[#f8fafc] flex items-center justify-center py-8 px-4 font-[system-ui,-apple-system,sans-serif] text-slate-900">
      <div className="bg-white rounded-2xl py-10 px-8 text-center max-w-[420px] w-full shadow-[0_4px_24px_rgba(0,0,0,0.08)]">
        {r.logo_url ? (
          ...
          <div
            aria-hidden="true"
            className="w-[88px] h-[88px] rounded-[14px] bg-slate-100 flex items-center justify-center text-[2.4rem] mx-auto mb-4"
          >
            🍽️
          </div>
        )}
        ...
        {r.city && (
          <p className="text-slate-500 text-[0.95rem] mt-0 mb-[0.7rem]">
            📍 {r.city}
          </p>
        )}
        ...
        <p className="text-slate-500 text-[0.95rem] mt-0 mb-[1.4rem] leading-normal">
        ...
        {phone ? (
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-wa text-white font-semibold text-[0.95rem] py-[0.85rem] px-[1.4rem] rounded-[10px] no-underline w-full box-border shadow-[0_2px_8px_rgba(22,163,74,0.3)]"
          >
          ...
          <button
            type="button"
            disabled
            className="bg-slate-200 text-slate-500 font-semibold text-[0.95rem] py-[0.85rem] px-[1.4rem] rounded-[10px] border-0 w-full cursor-not-allowed"
          >
            Coming soon
          </button>
        )}

        <p className="mt-[1.6rem] text-[0.72rem] text-slate-400">
