  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] flex items-center justify-center py-8 px-4 font-[system-ui,-apple-system,sans-serif] text-slate-900">
      <div className="bg-white rounded-2xl py-10 px-8 text-center max-w-[420px] w-full shadow-[0_4px_24px_rgba(0,0,0,0.08)]">
        ...
        <h1 className="text-2xl font-bold mt-0 mb-1.5">
          {r.display_name}
        </h1>

        {r.city && (
          <p className="text-slate-500 text-md mt-0 mb-3">
            📍 {r.city}
          </p>
        )}
        ...
        <p className="text-slate-500 text-md mt-0 mb-6 leading-normal">
        ...
        {phone ? (
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-wa text-white font-semibold text-md py-3.5 px-6 rounded-r no-underline w-full box-border shadow-[0_2px_8px_rgba(22,163,74,0.3)]"
          >
          ...
          <button
            type="button"
            disabled
            className="bg-slate-200 text-slate-500 font-semibold text-md py-3.5 px-6 rounded-r border-0 w-full cursor-not-allowed"
          >
            Coming soon
          </button>
        )}
