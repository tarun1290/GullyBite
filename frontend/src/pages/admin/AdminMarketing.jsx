...
import { getAdminMarketingMessages } from '../../api/admin.js';

// Mirrors admin.html loadAdminMarketingMessages/mktAdminPage (5253-5304).
// Admin-wide marketing message audit with restaurant/date filters + paging.
...
export default function AdminMarketing() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      const d = await getAdminMarketingMessages(params);
      setRows(d?.items || []);
...
const input = { background: 'var(--gb-neutral-0)', border: '1px solid var(--rim)', borderRadius: 6, padding: '.4rem .6rem', fontSize: '.8rem' };
