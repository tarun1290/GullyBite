...
const ITEMS = [
  ...
  {
    q: 'Is there any per-order commission on top of the monthly fee?',
  ...
  },
  {
    ...
    a: 'One click in Settings. No lock-in contract, no notice period, no exit fee. Your customer list stays with you on the way out \u2014 export it any time as a CSV.',
  },
];
