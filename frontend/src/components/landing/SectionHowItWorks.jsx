const STEPS = [
  {
    n: '1',
    h: 'Sign up',
    p: 'Create your GullyBite account in under a minute. No setup fee, no sales call required.',
  },
  {
    n: '2',
    h: 'Connect WhatsApp',
    p: 'One-click Meta login links your WhatsApp Business number and auto-creates your catalog.',
  },
  {
    n: '3',
    h: 'Upload menu',
    p: 'Import items in bulk or add them manually. Toggle availability and pricing in seconds.',
  },
  {
    n: '4',
    h: 'Go live',
    p: 'Share your WhatsApp link on Instagram, bill prints and Google listing — orders hit your dashboard live.',
  },
];
