const ROWS = [
  {
    ...
    them: '25\u201330% of every order',
    us: 'Flat monthly fee, zero %',
  },
  {
    label: 'Customer ownership',
    them: 'Platform owns every contact',
    us: 'Every phone number is yours',
  },
  {
    label: 'Customer messaging',
    them: 'Direct contact blocked',
    us: 'WhatsApp-native, no gatekeeper',
  },
  {
    label: 'Visibility',
    them: 'Pay-to-play ads & ranking',
    us: 'Your own WhatsApp link',
  },
  {
    label: 'Menu control',
    them: 'Platform UI, approval delays',
    us: 'Your catalog, instant sync',
  },
  {
    label: 'Branding',
    them: 'Platform-first lockup',
    us: 'Your brand, your colours',
  },
  {
    label: 'Payouts',
    them: 'T+7 or longer',
  ...
  {
    label: 'Discounts',
    them: 'Restaurant-funded, often forced',
    us: 'Your rules, your rates',
  },
  {
    label: 'Data & analytics',
    them: 'Whatever they choose to show',
    us: 'Full order ledger, exportable',
  },
];
