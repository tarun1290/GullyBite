const BLOCKS = [
  { num: '01', label: 'Own the storefront', body: 'Your brand, your menu, your catalog. No platform header, no competitor tiles next to your listing.' },
  { num: '02', label: 'Own the customer',   body: 'Every phone number belongs to you. Message, re-engage and reward without asking a platform for permission.' },
  { num: '03', label: 'Own the data',       body: "Orders, repeat rates and item trends are yours to analyse and act on. Not locked in someone else's dashboard." },
  { num: '04', label: 'Own the economics',  body: "Flat monthly fee. Zero per-order commission. Every extra order scales your margin, not the platform's." },
];
