...
const ST_CLR  = { open: '#3b82f6', assigned: '#8b5cf6', in_progress: '#f59e0b', waiting_customer: '#6366f1', escalated_to_admin: '#dc2626', resolved: '#16a34a', closed: '#64748b', reopened: '#ef4444' };
...
export default function IssueList({ issues, selectedId, onSelect, loading }) {
  if (loading) {
    return (
