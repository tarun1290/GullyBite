...
// WA_CONNECT_LABEL_DEFAULT — canonical label copied from legacy shared.js:73.
...
export default function WaConnectBanner({ onConnected, connected = false, compact = false }) {
