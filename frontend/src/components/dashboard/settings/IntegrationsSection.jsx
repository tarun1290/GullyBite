// Mirrors the POS_DISABLED=true branch of loadIntegrations() in legacy
// settings.js:1782-1801. Three POS tiles are rendered greyed-out with a
// "Coming soon" badge and no API wiring. When ENABLE_POS_INTEGRATIONS is
// ever flipped on server-side, the active flow lives in legacy and will
// need to be ported — left as a FUTURE FEATURE marker below.
