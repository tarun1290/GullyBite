...
import { assignProductToBranch } from '../../../api/restaurant.js';

// Mirrors #assign-branch-modal + openAssignBranchModal + doAssignBranch
// (menu.js:2530-2568). Lets the operator drop a product onto a specific
// branch with an optional per-branch price/tax override.
export default function AssignBranchModal({ productId, productName, branches, onClose, onSaved }) {
